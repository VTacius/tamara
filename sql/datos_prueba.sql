-- Establecimientos
SELECT crear_establecimiento('OpenDNS', POINT(13.729855674886958, -89.21425114110878));
SELECT crear_establecimiento('Lejania', POINT(13.733691037243023, -89.16438351047562));
SELECT crear_establecimiento('Nonwhere', POINT(13.722768427236153, -89.21575317817604));
SELECT crear_establecimiento('Lejano', POINT(13.725645041806475, -89.16562805547422));
SELECT crear_establecimiento('Cloudfare', POINT(13.713304533367593, -89.19481048992392));
SELECT crear_establecimiento('SVNet', POINT(13.710260997436652, -89.20077572284819));
SELECT crear_establecimiento('Google', POINT(13.710219304889753, -89.20107613026164));
